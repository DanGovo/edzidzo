...
<!-- Modal -->
<div class="modal fade top" id="view-class-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            {!! Form::label('class_name', 'Class ID:') !!}
            <input type="text" name="class_id" id="class_id" readonly>
        </div>
