...
<li class="{{ Request::is('lecturers*') ? 'active' : '' }}">
    <a href="{{ route('lecturers.index') }}"><i class="fa fa-user-circle"></i><span>Lecturers</span></a>
</li>
...
<li class="{{ Request::is('classSches*') ? 'active' : '' }}">
    <a href="{{ route('classSches.index') }}"><i class="fa fa-edit"></i><span>Class Sches</span></a>
</li>
